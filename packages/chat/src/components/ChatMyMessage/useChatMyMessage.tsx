...
import type { ChatMyMessageProps, ChatMyMessageState } from './ChatMyMessage.types';
...
export const useChatMyMessage_unstable = (
  ...
  const nativeProps = getPartitionedNativeProps<
    ChatMyMessageProps & Pick<React.HTMLAttributes<HTMLElement>, 'style' | 'className' | 'tabIndex'>,
    'tabIndex'
  >({
