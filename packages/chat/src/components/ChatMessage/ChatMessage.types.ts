...
/**
 * State used in rendering ChatMessage
 */
export type ChatMessageState = ComponentState<ChatMessageSlots> &
  Pick<ChatMessageProps, 'attached' | 'decoration' | 'persistentTimestamp' | 'showAnimation'> & {
    /**
