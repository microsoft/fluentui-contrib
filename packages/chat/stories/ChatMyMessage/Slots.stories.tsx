...
export const Slots = () => {
  return (
    <Chat>
      ...
      <ChatMyMessage author="Ashley McCarthy">Message with author</ChatMyMessage>
      <ChatMyMessage decorationLabel="important!" decorationIcon={<Question20Regular />}>
        Message with decoration icon and label
      </ChatMyMessage>
      <ChatMyMessage timestamp="8:00 AM">Message with timestamp</ChatMyMessage>
      <ChatMyMessage reactions={<Reactions />}>Message with reactions</ChatMyMessage>
    </Chat>
  );
};
