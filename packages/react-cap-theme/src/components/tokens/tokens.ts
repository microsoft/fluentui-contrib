...
export const tokens: Record<TokenName, string> = {
	...
	// CAP global line heights
	lineHeightBase450: "var(--lineHeightBase450)",

	// FIXME: Missing from @fluentui/tokens in fluentui-contrib. Remove once updated.
