import type { AvatarSlots, AvatarState } from '@fluentui/react-avatar';
...
/**
 * Class names used in Avatar slots
 * @alpha
 */
 ...
 */
const badgeMask = (margin?: string): string => {
...
/**
 * Use this hook to create the styles required to render Avatar.
 * @alpha
 */
