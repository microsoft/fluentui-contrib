...
/**
 * CSS class names for the CAP SplitButton component slots.
 * @alpha
 */
...
/**
 * Creates padding styles with stroke width adjustment
 */
...
/**
 * Creates size-based styles for dimensions
 */
...
const useRootAppearanceStyles = makeStyles({
	...
	// Empty objects are required so `rootAppearanceStyles[state.appearance]` resolves
	// to a valid (no-op) class instead of `undefined`.
	outlineColor: {},
	primary: {},
	outline: {},
	secondary: {},
...
/**
 * Apply styling to the CAP SplitButton component.
 * @param state - The SplitButton state object containing appearance and slot configuration
 * @returns The updated SplitButton state with applied styling classes
 * @alpha
 */
