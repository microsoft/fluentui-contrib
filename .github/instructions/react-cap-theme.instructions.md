---
applyTo: '**/packages/react-cap-theme/**'
---

The `@fluentui/react-cap-theme` package implements a `@fluentui/react-components` theme. Its source code lives inside `packages/react-cap-theme`.
