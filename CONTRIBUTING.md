...
yarn nx generate @fluent-contrib/nx-plugin:library <name>

# Configures storybook for the package
yarn nx generate @fluent-contrib/nx-plugin:configure-storybook <name>

# Configures playwright browser testing for the package
yarn nx generate @fluent-contrib/nx-plugin:playwright-component-configuration <name>

# Scaffolds a new component with sample implementation and example documentation
yarn nx generate @fluent-contrib/nx-plugin:component <name> <componentName>

# Starts the storybook for you new package and component
yarn nx run storybook:<name>
```
